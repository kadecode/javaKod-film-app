...
public class FilmlerDao {
    public ArrayList<Filmler> tumFilmlerByKategoriId(VeriTabani vt,int kategori_id){
        ...
        Cursor c = db.rawQuery("SELECT * FROM kategoriler,filmler,yonetmenler,WHERE filmler.kategori_id = kategoriler.kategori_id and filmler.yoneten_id = yonetmenler.yonetmen_id and filmler.kategori_id="+kategori_id,null);
